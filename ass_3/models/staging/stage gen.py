...
write_stg("customers_stg.sql", customers_query)
write_stg("products_stg.sql", products_query)
write_stg("shops_stg.sql", shops_query)
write_stg("employees_stg.sql", employees_query)
write_stg("orders_stg.sql", orders_query)
write_stg("order_items_stg.sql", order_items_query)
write_stg("payments_stg.sql", payments_query)
write_stg("discounts_stg.sql", discounts_query)
write_stg("reviews_stg.sql", reviews_query)
write_stg("wishlists_stg.sql", wishlists_query)
write_stg("platforms_stg.sql", platforms_query)
